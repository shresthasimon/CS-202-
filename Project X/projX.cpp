...
// Purpose: Test Drive file for SmartPtr class
...
int main(){
	...
	cout << endl <<
	"End-of-Scope, Destructors called in reverse order of SmartPtr creation (spNull_assign, spNull_cpy, spNull, sp3, sp2, sp1):" << endl; 
	return 0;	
}
